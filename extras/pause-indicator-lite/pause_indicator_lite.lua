...
local function draw_rectangles()
    return string.format([[{\rDefault\an5\p1\alpha&H%s\1c&H%s&\3c&H%s&}m 0 0 l %d 0 l %d %d l 0 %d m %d 0 l %d 0 l %d %d l %d %d\r]],
...
local function draw_triangle()
    return string.format([[{\rDefault\an5\p1\alpha&H%s\1c&H%s&\3c&H%s&}m 0 0 l %d %d l 0 %d\r]], 
