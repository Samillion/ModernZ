...
You can easily control other ModernZ or mpv options when PiP is enabled by using an auto-profile in `mpv.conf`, for example:
...
[Window-PiP]
    ...
    script-opts-append=modernz-ontop_in_topbar=yes
